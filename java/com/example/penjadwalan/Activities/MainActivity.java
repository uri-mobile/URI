package com.example.lenovo.splashh;
...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //define atribut
        ...
        background.animate().translationY(-1300).setDuration(2000).setStartDelay(300);
        clover.animate().translationY(-1300).setDuration(3000).setStartDelay(600);
        splashscreen.animate().translationY(140).alpha(0).setDuration(3000).setStartDelay(300);
